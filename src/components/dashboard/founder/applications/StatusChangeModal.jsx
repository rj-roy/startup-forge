...
export default function StatusChangeModal({ application, newStatus, onClose, onConfirm }) {
    ...
    const message = isApprove
        ? `You are about to approve ${application.fullName}'s application for "${application.opportunityName}". They will be notified of your decision.`
        : isReject
            ? `You are about to reject ${application.fullName}'s application for "${application.opportunityName}". This action cannot be undone.`
            : `You are about to change the status of ${application.fullName}'s application.`;
