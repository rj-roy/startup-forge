...
export default function StChangeModal({ startup, newStatus, onClose, onConfirm }) {
    ...
    const title = isApprove ? "Approve Startup?" : isReject ? "Reject Startup?" : "Update Status?";

    const message = isApprove
        ? `You are about to approve "${startup.startup_name}". This startup will be visible to all users on the platform.`
        : isReject
            ? `You are about to reject "${startup.startup_name}". The founder will be notified of this decision.`
            : `You are about to change the status of "${startup.startup_name}".`;

    const iconColor = isApprove
