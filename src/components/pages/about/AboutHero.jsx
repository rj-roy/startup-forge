export default function AboutHero() {
    return (
        <div className="relative overflow-hidden bg-white dark:bg-black-bg border-b border-gray-200 dark:border-gray-800 pt-24 pb-32 px-4 sm:px-6 lg:px-8">
            {/* Background Decor */}
            ...
            <div className="relative max-w-4xl mx-auto text-center">
                ...
                <h1 className="text-4xl sm:text-6xl font-extrabold text-gray-900 dark:text-white tracking-tight mb-6">
                    Building the future of work, <br className="hidden sm:block" />
                ...
                <p className="text-lg sm:text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto leading-relaxed">
                    We are on a mission to bridge the gap between visionary founders and talented collaborators. No gatekeepers, just pure innovation.
                </p>
            </div>
        </div>
    );
